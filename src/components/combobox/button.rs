...
#[derive(Props)]
pub struct ComboboxButtonProps<'cx, G: Html> {
...
#[component]
pub fn ComboboxButton<'cx, G: Html>(cx: Scope<'cx>, props: ComboboxButtonProps<'cx, G>) -> View<G> {
    ...
    element.set_attribute("data-sh".into(), "combobox-button".into());
